public class Pessoa {
    ...
    protected double renda_pessoal;
    ...
    public double getRenda_pessoal() {
        return renda_pessoal;
    }

    public void setRenda_pessoal(double renda_pessoal) {
        this.renda_pessoal = renda_pessoal;
    }
